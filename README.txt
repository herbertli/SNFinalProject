...
- mdata.json - aggregate donation data for all senators
...
- vdata.json - aggregate data for all senators
...
**Starred** files are probably the more interesting ones to look at
